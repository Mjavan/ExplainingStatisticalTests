...
class GradCAM(ProbBase):
    def set_hook_func(self):
        def func_b(module, grad_in, grad_out):
            ...
            print(id(module))
            print(self.outputs_backward[id(module)].shape)
            print(self.outputs_backward[id(module)].sum())
        ...
        def func_f(module, input, f_output):
            ...
            print(id(module))
            print(f"forward: {self.outputs_forward[id(module)].shape}")
    ...
    def generate(self):
        ...
        # print(f"\nGetting gradient in generate:{self.grads.sum()}")
